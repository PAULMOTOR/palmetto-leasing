...
async function upsertVehicle(
  ...
  await sql`
    ...
    on conflict (id) do update set
      ...
      exterior_color = case when excluded.exterior_color <> '' then excluded.exterior_color else vehicles.exterior_color end,
      interior_color = case when excluded.interior_color <> '' then excluded.interior_color else vehicles.interior_color end,
